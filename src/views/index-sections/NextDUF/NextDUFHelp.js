    ...
    return (
        <Grid className={classes.formStyle}>
            <Grid className={classes.labelStyle}>
                ...
                Its execution returns the next DUF code generated for the evaluated sequence. `}
            </Grid>
            <Grid className={classes.textStyle}>
                {`Once the function is executed, the next DUF code generated appears on the screen.`}
            </Grid>
            <Grid
                container
                justify="center"
