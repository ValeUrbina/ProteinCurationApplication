...
//Para las vistas
import OverlapWindow from "./overlap/OverlapView"
import HelpWindow from "./overlap/OverlapHelp"
import ReferenceWindow from "./overlap/OverlapReference"
...
export default function SPCleanerModal(props) {
    ...
    function ChangeWindow({ isReference, isHelp }) {
        if (isReference) {
            return <ReferenceWindow handleClose={handleClose} showOverlapWindow={showOverlapWindow} />;
        } else if (isHelp) {
            return <HelpWindow handleClose={handleClose} showOverlapWindow={showOverlapWindow} />;
        } else {
            return <OverlapWindow handleClose={handleClose} />;
        }
    }
