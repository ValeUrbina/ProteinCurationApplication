...
export default function HelpWindow(props) {
    ...
    const showMissingWindow = props.showMissingWindow;
    ...
    return (
        <Grid className={classes.formStyle}>
            <Grid className={classes.labelStyle}>
                ...
                Its execution returns all the missing sequences and the found sequences after the curation. `}
            </Grid>
            <Grid className={classes.textStyle}>
                {`Once the function is executed, both lists appears on the screen.`}
            </Grid>
            <Grid
                container
                justify="center"
