...
//Para las vistas
import NextDUFWindow from "./NextDUF/NextDUFView"
import HelpWindow from "./NextDUF/NextDUFHelp"
import ReferenceWindow from "./NextDUF/NextDUFReference"
...
export default function EfetchModal(props) {
    ...
    function ChangeWindow({ isReference, isHelp }) {
        if (isReference) {
            return <ReferenceWindow handleClose={handleClose} showNextDUFWindow={showNextDUFWindow} />;
        } else if (isHelp) {
            return <HelpWindow handleClose={handleClose} showNextDUFWindow={showNextDUFWindow} />;
        } else {
            return <NextDUFWindow handleClose={handleClose} />;
        }
    }
