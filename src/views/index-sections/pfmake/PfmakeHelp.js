...
export default function HelpWindow(props) {
    ...
    const shoPfmakeWindow = props.showPfmakeWindow;
    ...
    return (
        <Grid className={classes.formStyle}>
            <Grid className={classes.labelStyle}>
                ...
                Its execution creates the Hidden Markov Model corresponding to the alignment. `}
            </Grid>
            ...
            <Grid className={classes.textStyle}>
                {`Once the function is executed, the result appears on the screen.`}
            </Grid>
            <Grid
                container
                justify="center"
