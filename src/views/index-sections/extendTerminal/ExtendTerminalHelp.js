...
const rows = [
    createData("N-terminal aminoacids", "Numeric", "0<X"),
    createData("C-terminal aminoacids", "Numeric", "0<X"),
];
    ...
    return (
        <Grid className={classes.formStyle}>
            <Grid className={classes.labelStyle}>
                {`Extend N-terminal and C-terminal is a function developed by The European Bioinformatics Institute, 
                part of the European Molecular Biology Laboratory (EMBL-EBI). 
                Its execution returns the alignment extended. `}
            </Grid>
            ...
            <Grid className={classes.textStyle}>
                {`First choose and alignment method and enter the parameters. Once the function is executed, the extended alignment is presented.`}
            </Grid>
            <Grid
                container
                justify="center"
