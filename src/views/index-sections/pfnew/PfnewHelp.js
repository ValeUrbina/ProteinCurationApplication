...
export default function HelpWindow(props) {
    ...
    const showPfnewWindow = props.showPfnewWindow;
    ...
    return (
        <Grid className={classes.formStyle}>
            <Grid className={classes.labelStyle}>
                ...
                This function allows you to separate a new pfam code for a specific accession number in order to save it in the Pfam database`}
            </Grid>
