...
//Para las vistas
import PfnewWindow from "./pfnew/PfnewView"
import HelpWindow from "./pfnew/PfnewHelp"
import ReferenceWindow from "./pfnew/PfnewReference"
import SuccessWindow from "./pfnew/PfnewSuccess"
import ErrorWindow from "./pfnew/PfnewError"
import LoadingWindow from "./pfnew/PfnewLoading"
...
export default function PfnewModal(props) {
    ...
    function ChangeWindow({ isReference, isHelp }) {
        if (isReference) {
            return <ReferenceWindow handleClose={handleClose} showPfnewWindow={showPfnewWindow} />;
        } else if (isHelp) {
            return <HelpWindow handleClose={handleClose} showPfnewWindow={showPfnewWindow} />;
        } else {
            return <PfnewWindow handleClose={handleClose} />;
        }
    }
